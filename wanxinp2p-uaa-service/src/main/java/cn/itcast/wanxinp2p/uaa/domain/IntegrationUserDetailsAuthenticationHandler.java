...
public class IntegrationUserDetailsAuthenticationHandler {
	...
	public UnifiedUserDetails authentication(String domain, String authenticationType,
		...
		//4.登录成功，把用户的数据封装到 UnifiedUserDetails 对象中
		UnifiedUserDetails unifiedUserDetails = new UnifiedUserDetails(response.getResult().getUsername(),Password,AuthorityUtils.createAuthorityList());
